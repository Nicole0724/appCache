...
function addHeader() {
    ...
    _html += '<a class="logo" href="javascript:;"><img class="wsw_mt_26" src="assets/images/logo_04.png" /></a>';
    ...
    if (isUserLogin) {
        ...
        $("ul li.com_lesson").on('click', function () {
            ...
            $('.widget-box').removeClass('visible');
            $('#login_box').addClass('visible');
            nowUserClick = 'company_lesson.html';
        });
        // $("ul li.buy_history").on('click', function () {
        //     $('#wsw_login_reg').modal('open');
        //     $('.widget-box').removeClass('visible');
